...
@section('title', 'Dashboard | Hospital Management Systems')
@section('pages')
                ...
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Out Patients</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">In Patients</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Employees</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Pharmaceuticals</span>
                        </div>
                    </div>
                </div>
            </div>
