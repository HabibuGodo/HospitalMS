...
@section('title', 'Add Patient | Hospital Management Systems')
@section('style')
    <!-- Form step -->
    <link rel="stylesheet" href="{{ asset('assets/dashboard/vendor/jquery-smartwizard/dist/css/smart_wizard.min.css') }}">
@endsection
@section('pages')
                            ...
                            <div class="tab-content">
                                ...
                                <div id="wizard_Time" class="tab-pane" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="mb-3">
                                                <label class="text-label form-label">Next of Kin Name*</label>
                                                <input type="text" name="nextName" class="form-control"
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="mb-3">
                                                <label class="text-label form-label">Next of Kin Phone Number*</label>
                                                <input type="text" name="nextNumber" class="form-control"
...
@section('script')
    <!-- Form Steps -->
    <script src="{{ asset('assets/dashboard/vendor/jquery-smartwizard/dist/js/jquery.smartWizard.js') }}"></script>
    ...
    <!-- Daterange picker -->
    <link href="{{ asset('assets/dashboard/vendor/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
    <!-- Clockpicker -->
    <link href="{{ asset('assets/dashboard/vendor/clockpicker/css/bootstrap-clockpicker.min.css') }}" rel="stylesheet">
    <!-- asColorpicker -->
    <link href="{{ asset('assets/dashboard/vendor/jquery-asColorPicker/css/asColorPicker.min.css') }}" rel="stylesheet">
    <!-- Material color picker -->
    <link rel="stylesheet"
        href="{{ asset('assets/dashboard/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') }}">
    {{-- datepicker  --}}
    <link href="{{ asset('assets/dashboard/vendor/pickadate/themes/default.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/dashboard/vendor/pickadate/themes/default.date.css') }}" rel="stylesheet">
